...
void bonjour_parse_question_record(struct Squirrel *ferret, struct NetFrame *frame, const unsigned char *px, unsigned length,
						  struct DNSRECORD *rec, struct DNS *dns);
void bonjour_parse_resource_record(struct Squirrel *ferret, struct NetFrame *frame, const unsigned char *px, unsigned length,
						  struct DNSRECORD *rec, struct DNS *dns);
void bonjour_parse_record(struct Squirrel *ferret, struct NetFrame *frame, const unsigned char *px, unsigned length,
						  struct DNS *dns, struct DNSRECORD *rec, unsigned type);

void bonjour_txt_flush(struct Squirrel *ferret, struct NetFrame *frame, const unsigned char *px, unsigned length,
...
void dnssrv_parse_resource_record(struct Squirrel *ferret, struct NetFrame *frame, 
							const unsigned char *px, unsigned length,
							struct DNSRECORD *rec, struct DNS *dns);


void netbios_parse_resource_record(struct Squirrel *ferret, struct NetFrame *frame, 
							const unsigned char *px, unsigned length,
							struct DNSRECORD *rec, struct DNS *dns);
