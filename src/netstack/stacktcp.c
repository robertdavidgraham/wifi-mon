...
static void tcp_syn(struct Squirrel *squirrel, struct NetFrame *frame)
{
	UNUSEDPARM(squirrel);UNUSEDPARM(frame);
}
static void tcp_synack(struct Squirrel *squirrel, struct NetFrame *frame)
{
	UNUSEDPARM(squirrel);UNUSEDPARM(frame);
}
static void tcp_fin(struct Squirrel *squirrel, struct NetFrame *frame)
{
	UNUSEDPARM(squirrel);UNUSEDPARM(frame);
}
 ...
 */
static void 
tcp_ack_data(struct Squirrel *squirrel, struct NetFrame *frame, unsigned seqno)
{
...
void squirrel_http_useragent(struct Squirrel *squirrel, struct NetFrame *frame, const unsigned char *px, unsigned length)
{
    unsigned osver;
    char iptext[16];
...
void squirrel_http(struct Squirrel *squirrel, struct NetFrame *frame, const unsigned char *px, unsigned length)
{
    unsigned u, n;
 ...
 */
static void 
tcp_data(struct Squirrel *squirrel, struct NetFrame *frame, const unsigned char *px, unsigned length, unsigned seqno, unsigned ackno)
{
