...
void dns_dynamic_update(struct Squirrel *squirrel, struct NetFrame *frame, const unsigned char *px, unsigned length, struct DNS *dns)
{
	unsigned i;
 ...
 */
static void 
dns_parse_resource_record(struct Squirrel *squirrel, struct NetFrame *frame, 
...
static void 
dns_parse_question_record(struct Squirrel *squirrel, struct NetFrame *frame, 
						  const unsigned char *px, unsigned length, 
						  struct DNSRECORD *rec, struct DNS *dns)
{
	char name[512]; /* reserve a longer name than the max theoretical limit */
