...
void bonjour_txt_flush(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length,
...
void dnssrv_parse_resource_record(struct Squirrel *squirrel, struct StackFrame *frame, 
