...
ie_to_rate_list(struct InformationElement ie)
{
	...
	for (;;) {
		...
		if (rate_list->count < sizeof(rate_list->rates)/sizeof(rate_list->rates[0])) {
			rate_list->rates[rate_list->count++] = (unsigned char)found_rate;
		}
 ...
 */
static unsigned
ie_wpa1wme_to_crypto_flags(struct SQDB *sqdb, struct StackFrame *frame, const unsigned char *bssid, struct InformationElement ie)
{
 ...
 */
static unsigned
ie_wpa2rsn_to_crypto_flags(struct SQDB *sqdb, struct StackFrame *frame, const unsigned char *bssid, struct InformationElement ie)
{
	const unsigned char *px = ie.px;
	unsigned length = ie.length;
	unsigned offset = 0;
 ...
 * attaches the addresses to the "StackFrame" struction as if the packet
 ...
 * is extracting.
 */
void squirrel_get_mac_address(struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned direction;
 ...
 */
void squirrel_wifi_proberequest(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned offset;
	unsigned direction;
...
void squirrel_wifi_associate_request(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned direction;
	unsigned flags;
...
void squirrel_wifi_associate_response(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned direction;
	unsigned flags;
	unsigned status;
...
void squirrel_wifi_authentication(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
 ...
 * of multiple packets
 */
void squirrel_wifi_mgmt_action(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
...
void squirrel_wifi_deauthentication(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned reason;
	unsigned direction;
	unsigned dir;
 ...
 */
void squirrel_wifi_ctrl_power_save_poll(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned direction;
 ...
 */
void squirrel_wifi_ctrl_frame(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned direction;
 ...
 */
void squirrel_wifi_beacon(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned offset;
 ...
 */
void parse_lldp(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
    unsigned offset;
...
void squirrel_wifi_data(struct Squirrel *squirrel, struct StackFrame *frame, const unsigned char *px, unsigned length)
{
	unsigned offset=0;
	unsigned ethertype;
	unsigned oui;
...
unsigned filtered_out(struct StackFrame *frame, const char *mac_address)
{
