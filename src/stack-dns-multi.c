...
void bonjour_parse_question_record(struct Squirrel *squirrel, struct StackFrame *frame, 
...
void bonjour_parse_resource_record(struct Squirrel *squirrel, struct StackFrame *frame, 
							const unsigned char *px, unsigned length,
							struct DNSRECORD *rec, struct DNS *dns)
{
	char name[512]; /* reserve a longer name than the max theoretical limit */
